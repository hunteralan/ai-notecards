...
export function SidebarLayout({
  ...
  return (
    <>
      <div className="print:hidden relative isolate flex min-h-svh w-full bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
        {/* Sidebar on desktop */}
      ...
      <main className="hidden print:block">{children}</main>
    </>
  );
}
